 ...
 */
public class InterpreterDataHolder {
    ...
    private  static InterpreterDataHolder interpreterDataHolder = new InterpreterDataHolder();

    private InterpreterDataHolder(){
        streamAttributeNames = new ArrayList<String>();
        streamAttributeTypes = new ArrayList<String>();
    }

    public static InterpreterDataHolder getInterpreterDataHolder() {
        return interpreterDataHolder;
    }
